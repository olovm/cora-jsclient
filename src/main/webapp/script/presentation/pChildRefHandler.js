	...
	cora.pChildRefHandler = function(spec) {
		...
		function createNewBinaryData(file) {
			...
			return {
				...
				/*
				 skapa en funktion för att hämta upp attributet som skall användas här:
				 - hämta metadataGruppen för ny från recordType,
				 - läs attributeReferences, och skapa attributet/en från dess finalvalue/s 
				 */
				"attributes":{
					"type":"image"
				}
