	...
	coraTest.metadataProviderRealStub = function() {
		...
		function getMetadataById(metadataId) {
			...
			case "presentationTypeCollectionVar":
				...
				case "outputFormatCollectionVar":
					return {
						"children" : [ {
							"children" : [ {
								"name" : "id",
				...
				case "presentationGroupNewGroup":
					return {
						"children" : [ {
							"name" : "nameInData",
							"value" : "presentation"
				...
				case "presentationChildReferencesGroup":
					return {
						"children" : [ {
							"name" : "nameInData",
				...
				case "presentationChildReferenceGroup":
					return {
						"children": [
							{
								"name": "nameInData",
				...
				case "presentationTypePGroupCollectionVar":
					return {
						"children" : [
							{
								"children" : [
			...
			case "defaultPresentationCollectionVar":
				return {
					"children": [
						{
							"children": [
			...
			case "defaultPresentationCollection":
				return {
					"children": [
						{
							"children": [
			...
			case "outputFormatCollectionVarPVar":
				return {
				"name" : "presentation",
				"attributes" : {
					"type" : "pVar"
			...
			case "outputFormatCollectionVarOutputPVar":
				return {
				"name" : "presentation",
				"attributes" : {
					"type" : "pVar"
			...
			case "presentationGroupFormNewPGroup":
				return {
					"name" : "presentation",
					"attributes" : {
						"type" : "pGroup"
				...
				case "presentationGroupFormPGroup":
					return {
						"name" : "presentation",
						"attributes" : {
							"type" : "pGroup"
				...
				case "presentationGroupViewPGroup":
					return {
						"name" : "presentation",
						"attributes" : {
							"type" : "pGroup"
				...
				case "recordInfoNewPGroupPGroup":
				return {
					"name" : "presentation",
					"attributes" : {
						"type" : "pGroup"
				...
				case "presentationGroupMenuPGroup":
					return {
						"name" : "presentation",
						"attributes" : {
							"type" : "pGroup"
				...
				case "presentationOfTextGroupOutputPVar":
					return {
						"name" : "presentation",
						"attributes" : {
							"type" : "pVar"
				...
				case "presentationChildReferencesGroupPGroup":
					return {
						"name" : "presentation",
						"attributes" : {
							"type" : "pGroup"
				...
				case "presentationChildReferenceGroupPGroup":
					return {
						"name" : "presentation",
						"attributes" : {
							"type" : "pGroup"
				...
				case "presentationChildReferencesGroupViewPGroup":
					return {
						"name" : "presentation",
						"attributes" : {
							"type" : "pGroup"
				...
				case "presentationChildReferenceGroupViewPGroup":
					return {
						"name" : "presentation",
						"attributes" : {
							"type" : "pGroup"
				...
				case "presentationRefOutputPVar":
					return {
						"name" : "presentation",
						"attributes" : {
							"type" : "pVar"
				...
				case "presentationRefMinimizedPVar":
					return {
						"name" : "presentation",
						"attributes" : {
							"type" : "pVar"
				...
				case "presentationRefMinimizedOutputPVar":
					return {
						"name" : "presentation",
						"attributes" : {
							"type" : "pVar"
				...
				case "defaultPresentationCollectionVarPVar":
					return {
						"name" : "presentation",
						"attributes" : {
							"type" : "pVar"
				...
				case "defaultPresentationCollectionVarOutputPVar":
					return {
						"name" : "presentation",
						"attributes" : {
							"type" : "pVar"
				...
				case "presentationGroupListPGroup":
					return {
						"name" : "presentation",
						"attributes" : {
							"type" : "pGroup"
